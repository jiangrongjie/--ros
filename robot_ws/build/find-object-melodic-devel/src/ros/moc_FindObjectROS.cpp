...
#include "../../../../src/find-object-melodic-devel/src/ros/FindObjectROS.h"
...
QT_MOC_LITERAL(5, 55, 19), // "find_object::Header"
QT_MOC_LITERAL(6, 75, 6), // "header"
QT_MOC_LITERAL(7, 82, 7), // "cv::Mat"
QT_MOC_LITERAL(8, 90, 5), // "depth"
QT_MOC_LITERAL(9, 96, 13) // "depthConstant"
...
void FindObjectROS::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->publish((*reinterpret_cast< const find_object::DetectionInfo(*)>(_a[1])),(*reinterpret_cast< const find_object::Header(*)>(_a[2])),(*reinterpret_cast< const cv::Mat(*)>(_a[3])),(*reinterpret_cast< float(*)>(_a[4]))); break;
        default: ;
        }
    }
}
