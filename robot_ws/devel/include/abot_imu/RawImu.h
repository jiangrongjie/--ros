// Generated by gencpp from file abot_imu/RawImu.msg
// DO NOT EDIT!


#ifndef ABOT_IMU_MESSAGE_RAWIMU_H
#define ABOT_IMU_MESSAGE_RAWIMU_H
...
struct RawImu_
{
  ...
  typedef boost::shared_ptr< ::abot_imu::RawImu_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::abot_imu::RawImu_<ContainerAllocator> const> ConstPtr;

}; // struct RawImu_

typedef ::abot_imu::RawImu_<std::allocator<void> > RawImu;

typedef boost::shared_ptr< ::abot_imu::RawImu > RawImuPtr;
typedef boost::shared_ptr< ::abot_imu::RawImu const> RawImuConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::abot_imu::RawImu_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::abot_imu::RawImu_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::abot_imu::RawImu_<ContainerAllocator1> & lhs, const ::abot_imu::RawImu_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::abot_imu::RawImu_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::abot_imu::RawImu_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::abot_imu::RawImu_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::abot_imu::RawImu_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::abot_imu::RawImu_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::abot_imu::RawImu_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::abot_imu::RawImu_<ContainerAllocator> >
{
  ...
  static const char* value(const ::abot_imu::RawImu_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3bc0ea37781da51aULL;
  static const uint64_t static_value2 = 0xd41a6868ff62faa9ULL;
};

template<class ContainerAllocator>
struct DataType< ::abot_imu::RawImu_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::abot_imu::RawImu_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::abot_imu::RawImu_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::abot_imu::RawImu_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::abot_imu::RawImu_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // ABOT_IMU_MESSAGE_RAWIMU_H
